...
// category
const reportTotalOneCategorySellToday = async (req, res = response) => {
	try {
...
const reportTotalOneCategoryBuyToday = async (req, res = response) => {
	try {
		const { category } = req.params;
		const today = new Date();
		const year = today.getFullYear();
...
const reportTotalStockOneCategoryToday = async (req, res = response) => {
	try {
		const { category } = req.params;
