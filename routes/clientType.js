...
const { getClientTypes, getClientType, putClientType, deleteClientType, postClientType } = require('../controllers/clientType');
const { getClientTypeValidator, postClientTypeValidator, deleteClientTypeValidator, putClientTypeValidator } = require('../validations/clientType-validator');
