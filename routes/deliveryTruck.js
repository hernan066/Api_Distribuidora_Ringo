...
const { getDeliveryTrucks, getDeliveryTruck, putDeliveryTruck, deleteDeliveryTruck, postDeliveryTruck, getUserDeliveryTruck } = require('../controllers/deliveryTruck');
const { getDeliveryTruckValidator, postDeliveryTruckValidator, putDeliveryTruckValidator, deleteDeliveryTruckValidator, getUserDeliveryTruckValidator } = require('../validations/deliveryTruck-validator');
