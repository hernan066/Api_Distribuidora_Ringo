...
const { getSuppliers, getSupplier, putSupplier, deleteSupplier, postSupplier } = require('../controllers/supplier');
const { getSupplierValidator, postSupplierValidator, putSupplierValidator, deleteSupplierValidator } = require('../validations/supplier-validator');
